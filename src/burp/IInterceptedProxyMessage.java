 ...
 * by Burp Proxy. Extensions can register an <code>IProxyListener</code> to
...
public interface IInterceptedProxyMessage {
     ...
     * default action is <code>ACTION_FOLLOW_RULES</code>. If multiple proxy
     * listeners are registered, then other listeners may already have modified
     * the interception action before it reaches the current listener. This
