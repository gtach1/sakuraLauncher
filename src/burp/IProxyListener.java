...
public interface IProxyListener {
     ...
     * or a response.
     * @param message An <code>IInterceptedProxyMessage</code> object that
     * extensions can use to query and update details of the message, and
     * control whether the message should be intercepted and displayed to the
