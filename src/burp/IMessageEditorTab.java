...
/**
 * Extensions that register an <code>IMessageEditorTabFactory</code> must return
 * instances of this interface, which Burp will use to create custom tabs within
 * its HTTP message editors.
 */
public interface IMessageEditorTab {
     ...
     * for that message.
     *
     * @param content The message that is about to be displayed, or a
     ...
     * response.
     * @return The method should return <code>true</code> if the custom tab is
     * able to handle the specified message, and so will be displayed within the
     * editor. Otherwise, the tab will be hidden while this message is
     * displayed.
     */
     ...
     * message if the tab has already returned <code>true</code> to a call to
     * <code>isEnabled()</code> with the same message details.
     *
     * @param content The message that is to be displayed, or <code>null</code>
     * if the tab should clear its contents and disable any editable controls.
     * @param isRequest Indicates whether the message is a request or a
     * response.
     */
     ...
     *
     * @return The method should return <code>true</code> if the user has
