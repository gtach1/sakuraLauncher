...
public interface IMessageEditorTabFactory {
     ...
     *
     * @param controller An <code>IMessageEditorController</code> object, which
     * the new tab can query to retrieve details about the currently displayed
     * message. This may be <code>null</code> for extension-invoked message
     * editors where the extension has not provided an editor controller.
     * @param editable Indicates whether the hosting editor is editable or
     * read-only.
     * @return A new <code>IMessageEditorTab</code> object for use within the
     * message editor.
     */
