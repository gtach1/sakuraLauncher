 ...
 */
/**
 * This interface is used by an <code>IMessageEditor</code> to obtain details
 * about the currently displayed message. Extensions that create instances of
 * Burp's HTTP message editor can optionally provide an implementation of
