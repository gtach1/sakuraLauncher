...
public interface IHttpRequestResponse {
     ...
     * response.
     *
     * @return An <code>IHttpService</code> object containing details of the
     * HTTP service.
     */
     ...
     * response.
     *
     * @param httpService An <code>IHttpService</code> object containing details
     * of the new HTTP service.
     */
