...
public interface IScannerCheck {
     ...
     * passively scanned. <b>Note:</b> Extensions should only analyze the HTTP
     * messages provided during passive scanning, and should not make any new
     * HTTP requests of their own.
     *
     ...
     * active scanning, and should use the <code>IScannerInsertionPoint</code>
