...
public interface ISessionHandlingAction {
     ...
     * Otherwise, it is <code>null</code>. Actions can use the details of the
     * macro items to perform custom analysis of the macro to derive values of
     * non-standard session handling tokens, etc.
     */
    void performAction(
